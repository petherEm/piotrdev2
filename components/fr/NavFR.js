...
const NavFR = () => {
  ...
  return (
    <nav className="flex flex-col p-10 items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-40 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
