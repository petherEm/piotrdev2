...
const Socials = () => {
  return (
    <div className="flex items-center gap-x-3 md:gap-x-5 text-lg mt-4 md:mt-0">
      {/* <Link
        href="/"
      ...
      <Link
        ...
        target="_blank"
        className="hover:text-accent transition-all duration-300 text-[17px] md:text-xl"
      >
        <RiGithubLine />
      </Link>
      <Link
      ...
      <Link
        ...
        rel="noopener noreferrer"
        target="_blank"
        className="hover:text-accent transition-all duration-300 text-[12px] md:text-md"
      >
        Blog
      </Link>
      {/* Languages */}
