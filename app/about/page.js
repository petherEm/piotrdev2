    ...
    <div className="h-full bg-primary/30 py-18 md:py-22 text-center xl:text-left overflow-y-auto">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            With my butique studio, I bring a wealth of success and
            expertise from my thriving career in Fortune 500 companies. With a
            proven track record of delivering exceptional results, I am poised
            to bring the same level of excellence and drive to every project I
            undertake.
          </motion.p>
          {/* counter */}
          <motion.div
